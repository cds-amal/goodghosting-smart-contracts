              ...
              arguments: [
                {
                  ...
                  value: {
                    ...
                    kind: 'value',
                    value: { asBN: BigNumber("0x60a8addd"), rawAsBN: BigNumber("0x60a8addd") }
                  }
                },
                {
                  name: 'b',
                  ...
                  arguments: [
                    {
                      ...
                      value: {
                        ...
                        kind: 'value',
                        value: {
                          asBN: BigNumber("0x60a8addd"),
                          rawAsBN: BigNumber("0x60a8addd")
                        }
                      }
                    },
                    {
                      ...
                      value: {
                        ...
                        kind: 'value',
                        value: {
                          asBN: BigNumber("0x60a8aa57"),
                          rawAsBN: BigNumber("0x60a8aa57")
                        }
                      }
                    }
                  ],
